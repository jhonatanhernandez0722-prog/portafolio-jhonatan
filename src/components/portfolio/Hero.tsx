    ...
    <section id="top" className="relative overflow-hidden">
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(rgba(192,200,216,0.12) 1px, transparent 1px)",
        ...
        <img
          ...
          style={{ display: "block", width: "100%", height: "auto", position: "relative", zIndex: 10 }}
        />
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-5">
              ...
              <h1 className="text-5xl md:text-7xl font-bold leading-[0.95] tracking-tight">
                Desarrollo digital{" "}
                <span className="text-gradient">impactante</span> para
                experiencias memorables.
              </h1>
              <p className="max-w-2xl text-lg text-muted-foreground">
                Transformo ideas en productos atractivos, rápidos y funcionales.
                Diseño interfaces limpias con detalle y construyo arquitecturas
                que escalan.
              </p>
            </div>
